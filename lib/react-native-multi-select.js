...
import { GetPortalColor } from '../../../src/assets/colors';	
var portalColor;	
GetPortalColor().then((color) => portalColor = color);
...
export default class MultiSelect extends Component {
        ...
        <View
          style={[
            styles.selectedItem,
            {
              ...
              height: 35,
              borderColor: tagBorderColor //portalColor
            },
            tagContainerStyle || {}
          ]}
          // style={[
  ...
  _toggleSelector = () => {
    ...
    //   onToggleList();
    // }
    if (onToggleList && !this.state.selector) {
      onToggleList();
    }
  };
